...
- In the **setup->Integrations** and **setup->cloudproviders**, you will see your services. Please "accept" them, wait for a few minutes and the services should show up in Spinnaker.
